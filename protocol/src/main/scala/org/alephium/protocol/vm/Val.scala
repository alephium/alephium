...
object Val {
  ...
  object BoolVec extends Type {
    implicit val serde: Serde[BoolVec] = boolBufferSerde.xmap(BoolVec(_), _.a)
  ...
  object ByteVec extends Type {
    implicit val serde: Serde[ByteVec] = byteBufferSerde.xmap(ByteVec(_), _.a)
    ...
    def from(bytes: RandomBytes): ByteVec = ByteVec(ArrayBuffer.from(bytes.bytes))
  }
  object I64Vec extends Type {
    implicit val serde: Serde[I64Vec] = i64BufferSerde.xmap(I64Vec(_), _.a)
  ...
  object U64Vec extends Type {
    implicit val serde: Serde[U64Vec] = u64BufferSerde.xmap(U64Vec(_), _.a)
  ...
  object I256Vec extends Type {
    implicit val serde: Serde[I256Vec] = i256BufferSerde.xmap(I256Vec(_), _.a)
  ...
  object U256Vec extends Type {
    implicit val serde: Serde[U256Vec] = u256BufferSerde.xmap(U256Vec(_), _.a)
