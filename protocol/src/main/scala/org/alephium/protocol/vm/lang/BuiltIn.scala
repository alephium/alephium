...
object BuiltIn {
  ...
  val txInputSize: SimpleStatelessBuiltIn =
    SimpleStatelessBuiltIn("txInputSize", Seq.empty, Seq(Type.U256), TxInputSize)
  val uniqueTxInputAddress: SimpleStatelessBuiltIn =
    SimpleStatelessBuiltIn(
