...
sealed trait ArithOperator extends Operator {
  def getReturnType(argsType: Seq[Type]): Seq[Type] = {
    if (argsType.length != 2 || argsType(0) != argsType(1) || !Val.isNumeric(argsType(0).toVal)) {
...
case object Add extends ArithOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(I64Add)
      case Type.U64  => Seq(U64Add)
...
case object Sub extends ArithOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(I64Sub)
      case Type.U64  => Seq(U64Sub)
...
case object Mul extends ArithOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(I64Mul)
      case Type.U64  => Seq(U64Mul)
...
case object Div extends ArithOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(I64Div)
      case Type.U64  => Seq(U64Div)
...
case object Mod extends ArithOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(I64Mod)
      case Type.U64  => Seq(U64Mod)
...
case object Eq extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(EqI64)
      case Type.U64  => Seq(EqU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfNeI64(offset))
      case Type.U64  => Seq(IfNeU64(offset))
...
case object Ne extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(NeI64)
      case Type.U64  => Seq(NeU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfEqI64(offset))
      case Type.U64  => Seq(IfEqU64(offset))
...
case object Lt extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(LtI64)
      case Type.U64  => Seq(LtU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfGeI64(offset))
      case Type.U64  => Seq(IfGeU64(offset))
...
case object Le extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(LeI64)
      case Type.U64  => Seq(LeU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfGtI64(offset))
      case Type.U64  => Seq(IfGtU64(offset))
...
case object Gt extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(GtI64)
      case Type.U64  => Seq(GtU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfLeI64(offset))
      case Type.U64  => Seq(IfLeU64(offset))
...
case object Ge extends TestOperator {
  override def genCode(argsType: Seq[Type]): Seq[Instr[StatelessContext]] = {
    argsType(0) match {
      case Type.I64  => Seq(GeI64)
      case Type.U64  => Seq(GeU64)
  ...
  override def toBranchIR(left: Seq[Type], offset: Byte): Seq[Instr[StatelessContext]] = {
    left(0) match {
      case Type.I64  => Seq(IfLtI64(offset))
      case Type.U64  => Seq(IfLtU64(offset))
