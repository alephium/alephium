...
sealed trait ConstInstr0 extends ConstInstr with InstrCompanion0 {
  def const: Val
...
sealed trait ArithmeticInstr extends InstrCompanion0
...
sealed trait ConversionInstr[R <: Val, U <: Val] extends InstrCompanion0 {
