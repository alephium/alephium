...
trait ApiModelCodec {
  ...
  implicit val buildMultiInputsTransactionSourceRW: RW[BuildMultiInputsTransaction.Source] = macroRW

  implicit val buildMultiInputsTransactionRW: RW[BuildMultiInputsTransaction] = macroRW
