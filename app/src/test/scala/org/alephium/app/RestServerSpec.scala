...
abstract class RestServerSpec(
    ...
    val maxFormBufferedKiloByte: Int = 1
...
trait RestServerFixture
  ...
  val utxosLimit: Int
  val maxFormBufferedKiloByte: Int
  ...
  override val configValues = {
    Map[String, Any](
      ...
      ("alephium.api.max-form-buffered-kilo-byte", maxFormBufferedKiloByte),
