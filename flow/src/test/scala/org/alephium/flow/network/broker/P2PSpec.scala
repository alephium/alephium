...
//      system.actorOf(
//        TestTcpController
//          .props(bindAddress, blockFlow, blockflowSynchronize, brokerManager.ref))
...
//            brokerManager: ActorRefT[BrokerManager.Command]): Props =
//    Props(new TestTcpController(bindAddress, blockFlow, blockFlowSynchronizer, brokerManager))
//}
//
...
//      TestBrokerHandler.props(connection, blockFlow, blockFlowSynchronizer, brokerManager))
...
//            blockFlowSynchronizer: ActorRefT[BlockFlowSynchronizer.Command],
//            brokerManager: ActorRefT[BrokerManager.Command]): Props =
//    Props(new TestBrokerHandler(connection, blockflow, blockFlowSynchronizer, brokerManager))
//}
//
