...
class CompilerSpec extends AlephiumSpec with ContextGenerators {
  ...
  it should "test template variables" in {
...

    {
      ...
      val code =
        s"""
           ...
           |""".stripMargin
      val script = Compiler.compileTxScript(code).rightValue
      script.toTemplateString() is "0101000007004032{1}{2}{3}{4}1703170217011700{6}{7}{8}170617051704{5}18{0}1816030f2f7a4c0416000c2f1a0c7b16021603181816060e2f7a4c0416050d2f1a7a4c0416040c2f1a0c7b"
      runScript(
        script,
        AVector(
...

    {
      ...
      val script = Compiler.compileTxScript(code).rightValue
      script.toTemplateString() is "0101000006004035{1}{2}17011700{3}{4}{5}{6}1705170417031702{0}0c2f0c7b{7}0c7b16000c2f7a4c041601140100411a0c7b1603140101417a4c0416020d2f1a0c7b1605140102417a4c0416040e2f1a0c7b"
      runScript(
        script,
        AVector(
          Val.U256(0),
